...
VK::SwapChainSupportDetails::SwapChainSupportDetails(const VK::PhysicalDevice* device,
                                                     const VK::UnownedSurface &surface) : m_device(device), m_surface(surface) {
...
void VK::SwapChainSupportDetails::get_present_modes() {
...
VkSurfaceFormatKHR VK::SwapChainSupportDetails::choose_best_format() {
...
VkPresentModeKHR VK::SwapChainSupportDetails::choose_best_present_mode() {
...
VkExtent2D VK::SwapChainSupportDetails::choose_best_swap_extent(uint32_t window_width, uint32_t window_height) const {
...
uint32_t VK::SwapChainSupportDetails::get_optimal_chain_image_count() const {
